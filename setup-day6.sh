...
# Run database initialization to ensure we have base structure
./init-database.sh
...
docker exec -i web-security-lab-db /opt/mssql-tools18/bin/sqlcmd -S localhost -U sa -P "P@ssw0rd!" -C -i /docker-entrypoint-initdb.d/final-day-data.sql
